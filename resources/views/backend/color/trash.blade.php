        ...
        <div class="main-panel">
            <div class="content">
                <div class="container-fluid">
                    <h4 class="page-title">Color trash <h6 class="text-right">
                            ...
                            <a href="{{route('color.create')}}"> <button type="button" class="btn btn-sm btn-outline-primary">
                                    <span data-feather="plus"></span>
                                    Add New
                                </button> </a> <a href="{{ route('color.create') }}"><button class="btn btn-danger"><i class="bi bi-plus-lg"></i> Add New</button></a>
                        </h6>
                    </h4>
                    <div class="row">
