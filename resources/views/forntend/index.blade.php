            ...
            <div class=" px-xl-5 pb-3">
                ...
                <div class="py-3 py-md-3 bg-light">
                    <div class="container rounded">
                        <h5 class="border"> Products on this <a href="{{ route('frontend.products.index', $categorys->id) }}"><span class="text-danger">{{ $categorys->name }}</span></a> Category ( {{$categorys->products->count()}} Product) </h5>
                        <br>
                        <br>
                        <div class="row">
                            @forelse($categorys->products as $product)
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                                <div class="card product-item border-0 mb-4">
                                    ...
                                    <div class="card-footer d-flex justify-content-between bg-light border">
                                        <a href="{{ route('frontend.products.show', $product->id) }}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View
                                            Detail</a>
                            ...
                            @empty
                            <h1 class="text-center text-danger">No Available Product</h1>
                            @endforelse
